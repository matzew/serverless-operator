...
kafka_image "kafka-version-migration-source-$(metadata.get dependencies.eventing_kafka)__migrate"  "${eventing_kafka}-storage-version-migration"
kafka_image "kafka-version-migration-channel-$(metadata.get dependencies.eventing_kafka)__migrate" "${eventing_kafka}-storage-version-migration"
