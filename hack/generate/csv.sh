...
kafka_image "version-migration-kafka-source-$(metadata.get dependencies.eventing_kafka)__migrate"  "${eventing_kafka}-storage-version-migration"
kafka_image "version-migration-kafka-channel-$(metadata.get dependencies.eventing_kafka)__migrate" "${eventing_kafka}-storage-version-migration"
