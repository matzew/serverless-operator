...
kafka_image "storage-version-migration-eventing-kafka-source-$(metadata.get dependencies.eventing_kafka)__migrate" "${eventing_kafka}-storage-version-migration"
kafka_image "storage-version-migration-eventing-kafka-channel-$(metadata.get dependencies.eventing_kafka)__migrate" "${eventing_kafka}-storage-version-migration"
