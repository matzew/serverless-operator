...
kafka_image "storage-version-migration-eventing-kafka-source-eventing-kafka-$(metadata.get dependencies.eventing_kafka)__migrate" "${eventing_kafka}-storage-version-migration"
kafka_image "storage-version-migration-eventing-kafka-channel-eventing-kafka-$(metadata.get dependencies.eventing_kafka)__migrate" "${eventing_kafka}-storage-version-migration"
