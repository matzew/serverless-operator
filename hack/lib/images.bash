...
function default_knative_eventing_kafka_broker_images() {
  ...
  export KNATIVE_EVENTING_KAFKA_BROKER_RECEIVER="quay.io/creydr/knative/eventing-kafka-broker/receiver:1.11.1"
  export KNATIVE_EVENTING_KAFKA_BROKER_KAFKA_CONTROLLER="quay.io/matzew/kafka-controller:1.11.1"
  export KNATIVE_EVENTING_KAFKA_BROKER_WEBHOOK_KAFKA="quay.io/matzew/webhook-kafka:1.11.1"
