...
- `make install`: Scales the cluster appropriately, deploys serverless-operator, Knative Serving, Eventing and Kafka components.
...
- `make install-kafka`: Scales the cluster appropriately, deploys serverless-operator and Knative Kafka components.
